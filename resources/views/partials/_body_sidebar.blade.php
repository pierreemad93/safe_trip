    ...
    $MyNavBar = \Menu::make('MenuList', function ($menu) use ($url) {
        ...
        $menu->coupon
            ->add('<span>' . __('message.add_form_title', ['form' => __('message.coupon')]) . '</span>', [
                'class' => request()->is('coupon/*/edit') ? 'sidebar-layout active' : 'sidebar-layout',
                'route' => 'coupon.create',
            ])
        ...
        $menu
            ->add('<span>' . __('message.riderequest') . '</span>', ['class' => ''])
        ...
        $menu->riderequest
            ->add('<span>' . __('message.list_form_title', ['form' => __('message.riderequest')]) . '</span>', [
                'class' => 'sidebar-layout',
                'route' => 'riderequest.index',
            ])
            ->data('permission', 'riderequest list')
            ->prepend('<i class="fas fa-list"></i>')
            ->link->attr(['class' => '']);
        ...
        $menu->rent
            ->add('<span>' . __('message.list_form_title', ['form' => __('message.rent')]) . '</span>', [
                'class' => 'sidebar-layout',
                'route' => 'rent.index',
            ])
            ->data('permission', 'driver list')
        ...
        $menu
            ->add('<span>' . __('message.withdrawrequest') . '</span>', [
                'class' => '',
